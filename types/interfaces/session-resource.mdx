...
- [`ActiveSessionResource`](active-session-resource.mdx)
- [`PendingSessionResource`](pending-session-resource.mdx)

## Properties

| Property                                                   | Type                                    | Description                                                                                                                                             | Overrides                                                           | Inherited from                                                                  |
| ---------------------------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| <a id="end"></a> `end`                                     | () => `Promise`\<`SessionResource`\>    | Marks the session as ended. The session will no longer be active for this `Client` and its status will become **ended**.                                | -                                                                   | -                                                                               |
...
| <a id="user"></a> `user`                                   | <code>null \| UserResource</code>       | The user associated with the session.                                                                                                                   | -                                                                   | -                                                                               |
