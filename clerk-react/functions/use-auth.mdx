...
| Parameter                   | Type             |
| --------------------------- | ---------------- |
| `initialAuthStateOrOptions` | `UseAuthOptions` |

## Returns

| Name         | Type                                                                                                    | Description                                                                                                                                                                                                |
| ------------ | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `actor`      | <code>undefined \| null \| \{ [x: string]: unknown; sub: string; \}</code>                              | The JWT actor for the session. Holds identifier for the user that is impersonating the current user. Read more about [impersonation](/docs/users/user-impersonation).                                      |
...
| `has`        | <code>undefined \| CheckAuthorizationWithCustomPermissions \| CheckAuthorizationWithoutOrgOrUser</code> | A function that checks if the user has specific permissions or roles. See the [reference doc](/docs/references/backend/types/auth-object#has).                                                             |
