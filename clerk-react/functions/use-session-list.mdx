...
| `sessions`  | <code>undefined \| [SessionResource](/docs/references/javascript/session)[]</code> | A list of sessions that have been registered on the client device.                                                       |
| `setActive` | <code>undefined \| (setActiveParams) => Promise\<void\></code>                     | A function that sets the active session and/or organization.                                                             |
